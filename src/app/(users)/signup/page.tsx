...
export default function SignUp(props: { disableCustomTheme?: boolean }) {
  ...
  const validateInputs = () => {
    ...
    if((contact.value.length !== 10)||(contact.value[0] !== '9'))
    {
        setContactError(true) ;
        setContactErrorMessage('Enter a valid number') ;
        isValid = false ;
    }
    else{
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    if (nameError || numError || contactError) {
      ...
      <SignUpContainer direction="column" justifyContent="space-between">
        <Card variant="outlined">
          ...
          >
            ...
            <FormControl>
              <FormLabel htmlFor="num">Flat No./Id</FormLabel>
              <TextField
                required
                fullWidth
                id="num"
                placeholder="Enter Flat No. / Id"
                name="num"
                variant="outlined"
                error={numError}
